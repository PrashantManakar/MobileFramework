...
public class BaseTest {
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH", "/Library/Internet Plug-Ins/JavaAppletPlugin.plugin/Contents/Home/bin:/Users/prashantmanakar/Library/Android/sdk/tools:/Users/omprakashchavan/Library/Android/sdk/platform-tools:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "/Users/prashantmanakar/Library/Android/sdk");
  ...
  public void selectDropdownByText(MobileElement e, String dropdownOption,String msg) {	  
	  waitForVisibility(e);
	  utils.log().info(msg);
	  ExtentReport.getTest().log(Status.INFO, msg);
	  new Select(e).selectByVisibleText(dropdownOption);
  }
